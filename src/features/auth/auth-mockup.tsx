...
export default function AuthMockup({ onLogin }: AuthMockupProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-stone-900 flex flex-col lg:flex-row selection:bg-stone-900 selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-5/12 p-12 xl:p-20 flex-col justify-between border-r border-stone-200 relative bg-[#F5F4F0] overflow-hidden">
        ...
        <div className="relative z-10 max-w-sm">
          ...
          >
            <h2 className="font-serif text-5xl xl:text-6xl leading-[1.1] mb-6 text-stone-900">
      ...
      <div className="w-full lg:w-7/12 flex-1 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12 md:p-24 relative">
