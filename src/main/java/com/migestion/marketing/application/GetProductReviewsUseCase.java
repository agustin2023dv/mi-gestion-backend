...
public class GetProductReviewsUseCase {
    ...
    public PageResponse<ReviewResponse> execute(Long productoId, Pageable pageable) {
        Page<ReviewResponse> page = resenaProductoRepository
                .findByProductoIdAndIsPublishedTrue(productoId, pageable)
